...
$client = new SoapClient(
           ...
           $xml='<arg0><![CDATA[<?xml version="1.0" encoding="utf-8"?> 
            ...
            <origin_country>'.$cert_det['country_orig'].'</origin_country> 
             ...
             <mci_issuer>Saham Assurance Co. Ltd</mci_issuer> 
             <rotation_number>str1234</rotation_number> 
           ...
           if(trim($ucr_valid[0])=='F')
           {
              ...
              echo json_encode($res);
                ...
                $sql_upd="update certificates set kentrade='Y',k_response='". $kentrade_response."' where id=".$cert_id;
