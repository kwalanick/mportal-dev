                                        ...
                                        <div class="widget-header">
                                            ...
                                            <div class="widget-toolbar no-border">
                                                <ul class="nav nav-tabs" id="myTab">
                                                    ...
                                                    <li>
                                                        <a data-toggle="tab" href="#info">Premium Details</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                                        ...
                                                        <table border="0" class="table  table-bordered table-hover no-margin-bottom">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <select name="agent" style="width: 160px; ">
                                                                        <option selected><?php echo $_SESSION['agent']   ?></option>
                                                                    </select>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    <label>Cover</label>
                                                                    <!--<input type="text" name="agent" value="" readonly />-->
                                                                    <select name="cover" style="width: 220px; ">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="form-group">
                                                                    <label>Email</label>
                                                                    <input type="email" name="email" value="<?php if($_SESSION['agent']!='DIRECT'){}else{echo $email;} ?>"  required style="width: 150px;"/>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-group">
                                                                    <label>Mobile Number</label>
                                                                    <input type="text" name="mobileno" value="<?php if($_SESSION['agent']!='DIRECT'){}else{echo $mobileno;} ?>"  required style="width: 150px;"/>
                                                                    </div>
                                                                    </td>
                                                                    <td>
                                                                    <div class="form-group">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <input type="text" name="pin" maxlength="11" value="<?php if($_SESSION['agent']!='DIRECT'){}else{echo $pin_no;} ?>" minlength="11" pattern="^[a-zA-Z][a-zA-Z0-9]+$" style="text-transform:uppercase" style="width: 205px;" required="true" />
                                                                </div>      
                                                                </td>
                                                        ...
                                                        <table border="0" class="table  table-bordered table-hover no-margin-bottom">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <option selected="selected">Select Cover</option>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <?php
                                                                    $country = mysql_query("SELECT * FROM country where id!=14");
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="profile"><button class="btn btn-primary">Proceed </button></a>
                                                                </td>
                                                                <td>
                                                        ...
                                                        <table border="0" class="table  table-bordered table-hover no-margin-bottom">
                                                           <tr>
                                                               <td>
                                                                ...
                                                                <td>
                                                                    <div class="form-group">
                                                                    <label>Transhipment Destination City</label>
            ...
            //-----------insert into aims marineprop-------------------------------------------------------------------------//
               ...
               $month_description=date('M');
                ...
                $the_cert=$cert_number_latest['ID'];
                 ...
                 "<br>";
               echo $ora_sql = "INSERT INTO STDGBDATA.MARINEPROPOSAL 
                    (
