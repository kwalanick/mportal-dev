                                                    ...
                                                    <table border="0" class="table  table-bordered table-hover no-margin-bottom">-->
                                                               ...
                                                               <td>
                                                                ...
                                                                <td>
                                                                        ...
                                                                        <input type="hidden" name="w_rate" id="w_rate" value="<?php echo $w_rate; ?>"  readonly style="width: 50px;"/ >
                                                                        </div>      
                                                                </td>
                                                                 </tr>
                                                                 <tr>
...
if($_POST['submit']){ 
        ...
        $actual_dest['name']=$_POST['destcountry'];
           ...
           $sql= "insert into certificates( `category`,`cargo_type`, `shipping_mode`, `package_type`, `shp_cover_type`, `sum_insured`, `country_orig`, `country_dest`, `city_orig`, `city_dest`, `owner`, `email`, `mobile`, `p_from`, `p_to`, `pin`, `premium`,`userid`,`Total_premium`,`vessel`,`vessel_no`,`war`,`stamp`,`p_fund`,`levy`,`transhipment`,`transhipment_location`,`ucr`,`agent_branch`,`tranship_country`) values(".$_POST['cargotype'].",'".$_POST['cargotype1']."','".$_POST['shipmode']."','".$_POST['product']."','".$_POST['shipcover']."',".$_POST['suminsured'].",'".$actual_country['name']."','".$actual_dest['name']."','".$_POST['cityorigin']."','".$_POST['citydestination']."','".$_POST['owner']."','".$_POST['email']."','".$_POST['mobileno']."','".$_POST['periodfrom']."','".$_POST['periodto']."','".$_POST['pin']."','".$_POST['premium']."',".$_SESSION['userid'].",'".$_POST['tpremium']."','".$_POST['vname']. "','".$_POST['vnumber']. "',".$_POST['war_prem'].",".$_POST['stamp'].",".$_POST['fund'].",".$_POST['training'].",'".$_POST['trans']."','".$_POST['transcity']."','".$_POST['ucr']."',".$_POST['agent'].",'".$_POST['trans_country']."')";
